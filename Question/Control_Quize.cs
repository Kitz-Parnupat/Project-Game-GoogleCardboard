...
public class Control_Quize : MonoBehaviour
{
    // Set text 
    ...
    int[][] answer_Chack = new int[][]  //เรียงตามข้อ
    {
        ...
        new int[] {2,2,2,4},// ดาวพฤสับดี
        new int[] {3,4,3,1},// ดาวเสาร์
        new int[] {1,3,2,3},// ดาวยูเรนัส
    ...
    IEnumerator nextScene()
    {
       // print(Time.time);
        ...
        //AutoFade.LoadLevel("SpaceCraft", 3, 1, Color.black);
                        ...
                        if (PlayerPrefs.GetInt("Jupiter_Score") > 2)
                        {
                             if (PlayerPrefs.GetInt("Saturn_Score") > 2)
                            {
                                 if (PlayerPrefs.GetInt("Uranus_Score") > 2)
                                {
                                    ...
                                    {
                                       Application.LoadLevel("Scene Fin"); 
                                    }
                                    else
                                    {
    ...
    void CheckAnser()  //เอาปีกกาออก
    {
        ...
        if (planet == "Sun")
        {
            ...
            if (Count_Choice == 4 && Btn_Choice == answer_Chack[8][3])
                Score++;
            if (Score > 2)
                PlayerPrefs.SetInt("Sun_Score", Score);
        }
        //planet = ""; // คืนค่าตัวแปร
