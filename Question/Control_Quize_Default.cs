...
public class Control_Quize_Default : MonoBehaviour {
    // Set text 
    public Text Text_Head, Text_NO_select, Text_ShowError;
    ...
    void Start () {
      ...
      //  PlayerPrefs.SetString("Name_planet_q", "Venus");
        switch (PlayerPrefs.GetString("Name_planet_q"))
        {
            case "Sun":
                {
    ...
    public void InputBtnHead(bool status)
    {
         if (status == true)
        {
            ...
            //status = false;
            else Text_ShowError.text = "กรุณาเลือกคำตอบด้วย";
        }
        //if (Count_Choice > 4)
    ...
    void SetText()
    {
        if (planet == "Sun")
        {
            switch (Count_Choice)
            {
                case 1:
                    {
                        Head = "1. ภายในแก่นดวงอาทิตย์เกิดปฏิกิริยานิวเคลียร์ ฟิวชัน คิดเป็นการเปลียนมวลประมาณเท่าไร";
                        Btn1 = "1 ล้านตัน";
                        Btn2 = "2 ล้านตัน";
                        Btn3 = "3 ล้านตัน";
                        Btn4 = "4 ล้านตัน";
                ...
                case 2:
                    {
                        Head = "2. เส้นศูนย์สูตรดวงอาทิตย์ใช้เวลาหมุนรอบตัวเองประมาณกี่วัน";
                        Btn1 = "25 วัน";
                        Btn2 = "33 วัน";
                        Btn3 = "45 วัน";
                        Btn4 = "53 วัน";
                ...
                case 3:
                    {
                        Head = "3. เส้นผ่านศูนย์กลางของดวงอาทิตย์เป็นกี่เท่าของโลก";
                        Btn1 = "79 เท่าของโลก";
                        Btn2 = "97 เท่าของโลก";
                        Btn3 = "109 เท่าของโลก";
                        Btn4 = "129 เท่าของโลก";
                ...
                case 4:
                    {
                        Head = "4. ดวงอาทิตย์มีองค์ประกอบเป็นอะไร";
                        Btn1 = "หิน";
                        Btn2 = "แก็ส";
                        Btn3 = "ก๊าซ";
                        Btn4 = "สะสาร";
        ...
        if (planet == "Mercury")
        {
            switch (Count_Choice)
            {
                case 1:
                    {
                        Head = "1. คาบเวลาการโคจรรอบดวงอาทิตย์ของดาวพุธเป็นเวลาเท่าไร";
                        Btn1 = "59  วัน";
                        Btn2 = "88  วัน";
                        Btn3 = "160  วัน";
                        Btn4 = "260  วัน";
                ...
                case 2:
                    {
                        Head = "2. คาบเวลาการหมุนรอบตัวเองของดาวพุธเป็นเวลาเท่าไร";
                        Btn1 = "59  วัน";
                        Btn2 = "80  วัน";
                        Btn3 = "120  วัน";
                        Btn4 = "160  วัน";
                ...
                case 3:
                    {
                        Head = "3. พื้นพิวของดาวพุธเต็มไปด้วยอะไร";
                        Btn1 = "น้ำ";
                        Btn2 = "ลาวา";
                        Btn3 = "หลุมอุกกาบาต";
                        Btn4 = "แก๊ซ";
                ...
                case 4:
                    {
                        Head = "4. ดาวพุธมีส่วนประกอบหลักเป็นอะไร";
                        Btn1 = "โลหะ";
                        Btn2 = "ซิลิเกต";
                        Btn3 = "ซิลิก้อน";
                        Btn4 = "หินแข็ง";
            ...
            switch (Count_Choice)
                {
                    case 1:
                        {
                            Head = "1. คาบเวลาการโคจรรอบดวงอาทิตย์ของดาวศุกร์เป็นเวลาเท่าไร";
                            Btn1 = "50  วัน";
                            Btn2 = "88  วัน";
                            Btn3 = "160  วัน";
                            Btn4 = "260  วัน";
                    ...
                    case 2:
                        {
                            Head = "2. คาบเวลาการหมุนรอบตัวเองดาวศุกร์เป็นเวลาเท่าไร";
                            Btn1 = "159  วัน";
                            Btn2 = "221  วัน";
                            Btn3 = "243  วัน";
                            Btn4 = "259  วัน";
                    ...
                    case 3:
                        {
                            Head = "3. ดาวศุกร์เอียงทำมุมเท่าไร";
                            Btn1 = "90";
                            Btn2 = "177";
                            Btn3 = "199";
                            Btn4 = "230";
                    ...
                    case 4:
                        {
                            Head = "4. ชั้นบรรยากาศที่มีความหนาแน่นสูงและเต็มไปด้วยแก๊สอะไร";
        ...
        if (planet == "Earth")
        {
            ...
            switch (Count_Choice)
            {
                case 1:
                    {
                        Head = "1. ชั้นบรรยากาศที่มีความหนาแน่นสูงและเต็มไปด้วยแก๊สอะไร";
                        Btn1 = "แก๊สคาร์บอนไดออกไซด์";
                        Btn2 = "แก๊สมีเทน";
                        Btn3 = "แก๊สโซลีน";
                        Btn4 = "แก๊สฮีเลี่ยม";
                ...
                case 2:
                    {
                        Head = "2. คาบเวลาการหมุนรอบตัวเองโลกเป็นเวลาโดยประมาณเท่าไร";
                ...
                case 3:
                    {
                        Head = "3. โลกนั้นถือกำเนิดมาเป็นเวลาเท่าไร";
                        Btn1 = "3.54 พันล้านปี";
                        Btn2 = "4.45 พันล้านปี ";
                        Btn3 = "4.54 พันล้านปี";
                        Btn4 = "5.54 พันล้านปี";
                ...
                case 4:
                    {
                        Head = "4. โลกห่อหุ้มไปด้วยชั้นบรรยากาศที่มีความหนาหลายร้อยกิโลเมตร โดยประกอบไปด้วยแก๊สมากที่สุด";
                        Btn1 = "แก๊สคาร์บอนไดออกไซด์";
                        Btn2 = "แก๊สมีเทน";
                        Btn3 = "แก๊สโซลีน";
                        Btn4 = "แก๊สไนโตรเจน";
        ...
        if (planet == "Mars")
        {
            ...
            switch (Count_Choice)
            {
                case 1:
                    {
                        Head = "1. คาบเวลาการโคจรรอบดวงอาทิตย์ของดาวอังคารเป็นเวลาโดยประมาณเท่าไร";
                        Btn1 = "366 วัน";
                        Btn2 = "478  วัน";
                        Btn3 = "678  วัน ";
                        Btn4 = "768  วัน";
                ...
                case 2:
                    {
                        Head = "2. คาบเวลาการหมุนรอบตัวเองดาวอังคารเป็นเวลาโดยประมาณเท่าไร";
                        Btn1 = "22.63 ชั่วโมง";
                        Btn2 = "23.63 ชั่วโมง";
                        Btn3 = "24.63 ชั่วโมง";
                        Btn4 = "25.63 ชั่วโมง";
                ...
                case 3:
                    {
                        Head = "3. ชั้นบรรยากาศของดาวอังคารจะประกอบด้วยแก๊สอะไร";
                        Btn1 = "22 องศา";
                        Btn2 = "23 องศา";
                        Btn3 = "24 องศา";
                        Btn4 = "25 องศา";
                ...
                case 4:
                    {
                        Head = "4. ชั้นบรรยากาศของดาวอังคารจะประกอบด้วยแก๊สอะไร";
                        Btn1 = "แก๊สคาร์บอนไดออกไซด์";
                        Btn2 = "แก๊สมีเทน";
                        Btn3 = "แก๊สโซลีน";
                        Btn4 = "แก๊สไนโตรเจน";
        ...
        if (planet == "Jupiter")
        {
            ...
            switch (Count_Choice)
            {
                case 1:
                    {
                        Head = "1. คาบเวลาการโคจรรอบดวงอาทิตย์ของดาวพฤสับดีเป็นเวลาโดยประมาณเท่าไร";
                        Btn1 = "4,329 วัน";
                        Btn2 = "4,331 วัน";
                        Btn3 = "4,498 วัน ";
                        Btn4 = "4,578 วัน";
                ...
                case 2:
                    {
                        Head = "2. คาบเวลาการหมุนรอบตัวเองดาวพฤสับดีเป็นเวลาโดยประมาณเท่าไร";
                        Btn1 = "7.33 ชั่วโมง";
                        Btn2 = "8.93 ชั่วโมง";
                        Btn3 = "9.93 ชั่วโมง";
                        Btn4 = "10.93 ชั่วโมง";
                ...
                case 3:
                    {
                        Head = "3. ลักษณะเด่นของดาวพฤหัสบดีคืออะไร";
                        Btn1 = "ลมที่แรงที่สุด";
                        Btn2 = "จุดแดงใหญ่";
                        Btn3 = "มีน้ำ";
                        Btn4 = "วงแหวน";
                ...
                case 4:
                    {
                        Head = "4. ดาวพฤหัสบดีมีแกนหมุนเอียง";
                        Btn1 = "1.1 องศา";
                        Btn2 = "2.7 องศา";
                        Btn3 = "2.9 องศา";
                        Btn4 = "3.1 องศา";
        ...
        if (planet == "Saturn")
        {
            ...
            switch (Count_Choice)
            {
                case 1:
                    {
                        Head = "1. คาบเวลาการโคจรรอบดวงอาทิตย์ของดาวเสาร์เป็นเวลาโดยประมาณเท่าไร";
                        Btn1 = "8,832 วัน";
                        Btn2 = "9,832 วัน";
                        Btn3 = "10,832 วัน";
                        Btn4 = "11,832 วัน";
                ...
                case 2:
                    {
                        Head = "2. คาบเวลาการหมุนรอบตัวเองดาวเสาร์เป็นเวลาโดยประมาณเท่าไร";
                        Btn1 = "7.33 ชั่วโมง";
                        Btn2 = "8.93 ชั่วโมง";
                        Btn3 = "9.93 ชั่วโมง";
                        Btn4 = "10.66 ชั่วโมง";
                ...
                case 3:
                    {
                        Head = "3. ความหนาแน่นน้อยกว่าดาวเสาร์น้อยกว่าอะไร";
                        Btn1 = "หิน";
                        Btn2 = "ดิน";
                        Btn3 = "น้ำ";
                        Btn4 = "อากศ";
        ...
        if (planet == "Uranus")
        {
            ...
            switch (Count_Choice)
            {
                case 1:
                    {
                        Head = "1. ลักษณะเด่นของดาวยูเรนัส";
                        Btn1 = "วงแหวน";
                        Btn2 = "มีน้ำ";
                        Btn3 = "ลมที่แรงที่สุด";
                        Btn4 = "ฝนดาวตก";
                ...
                case 2:
                    {
                        Head = "2. คาบเวลาการหมุนรอบตัวเองดาวยูเรนัสเป็นเวลาโดยประมาณเท่าไร";
                        Btn1 = "10.24 ชั่วโมง";
                        Btn2 = "13.24 ชั่วโมง";
                        Btn3 = "17.24 ชั่วโมง";
                        Btn4 = "20.24 ชั่วโมง ";
                ...
                case 3:
                    {
                        Head = "3. วิลเลียม เฮอร์เซล ค้นพบดาวยูเรนัส เมือปี พ.ศ. ใด";
                        Btn1 = "พ.ศ. 2225";
                        Btn2 = "พ.ศ. 2325";
                        Btn3 = "พ.ศ. 2425";
                        Btn4 = "พ.ศ. 2525";
                ...
                case 4:
                    {
                        Head = "4. ดาวยูเรนัสีมีแกนหมุนเอียง";
                        Btn1 = "78 องศา";
                        Btn2 = "88 องศา";
                        Btn3 = "98 องศา";
                        Btn4 = "108 องศา";
        ...
        if (planet == "Neptune")
        {
            ...
            switch (Count_Choice)
            {
                case 1:
                    {
                        Head = "1. คาบเวลาการโคจรรอบดวงอาทิตย์ของดาวเนปจูนเป็นเวลาโดยประมาณเท่าไร";
                        Btn1 = "40,190 วัน";
                        Btn2 = "50,190 วัน";
                        Btn3 = "60,190 วัน";
                        Btn4 = "70,190 วัน";
                ...
                case 2:
                    {
                        Head = "2. คาบเวลาการหมุนรอบตัวเองดาวเนปจูนเป็นเวลาโดยประมาณเท่าไร";
                        Btn1 = "10.24 ชั่วโมง";
                        Btn2 = "13.24 ชั่วโมง";
                        Btn3 = "16.11 ชั่วโมง";
                        Btn4 = "20.24 ชั่วโมง ";
                ...
                case 3:
                    {
                        Head = "3. ดาวเนปจูนเป็นดาวที่มีอะไรด่น";
                        Btn1 = "วงแหวน";
                        Btn2 = "มีน้ำ";
                        Btn3 = "ลมที่แรงที่สุด";
                        Btn4 = "ฝนดาวตก";
    ...
    void CheckAnser()  //เอาปีกกาออก
    {
        if (Count_Choice > 3)
        {
            if (GotoScene == "Scene SpaceCraft") Application.LoadLevel(GotoScene);
