...
public class Control_Quize_V4 : MonoBehaviour {
    // Set text 
    ...
    int[][] answer_Chack = new int[][]  //เรียงตามข้อ
    {
        ...
        new int[] {1,2,2,4},// ดาวโลก
        new int[] {3,3,2,4},// ดาวอังคาร
        new int[] {2,3,2,4},// ดาวพฤสับดี
        new int[] {3,4,3,1},// ดาวเสาร์
    ...
    void SetText()
    {
            ...
            switch (Count_Choice)
                {
                    ...
                    case 2:
                        {
                            Head = "แกนชั้นในของดาวศุกร์ส่วนประกอบหลักคืออะไร";
                            Btn1 = "หินแข็ง";
                            Btn2 = "โลหะเหลว";
                            Btn3 = "โลหะแข็ง";
                            Btn4 = "หินเหลว";
                    ...
                    case 3:
                        {
                            Head = "ดาวศุกร์ได้ชื่อว่าเป็นดาวฝาแฝดของโลกเพราะสาเหตุใด";
                            Btn1 = "สีคล้ายโลก";
                            Btn2 = "มีขนาดและความหนาแน่นใกล้เคียงกัน";
                            Btn3 = "มีการเอียงทำมุมคล้ายโลก";
                            Btn4 = "อยู่ใกล้กับโลก";
                            break;
                        }
                    case 4:
        ...
        if (planet == "Jupiter")
        {
            ...
            switch (Count_Choice)
            {
                case 1:
                    {
                        Head = "ดาวพฤสับดีมีรูปร่างเป็นอย่างไร";
                        Btn1 = "รูปร่างทรงกลม";
                        Btn2 = "รูปร่างทรงกลมแป้น";
                        Btn3 = "รูปร่างทรงกลมรี";
                        Btn4 = "รูปร่างทรงกลมแบน";
                        break;
                    }

                case 2:
                    {
                        Head = "คาบเวลาการหมุนรอบตัวเองดาวพฤสับดีน้อยกว่าเท่าไร";
                        Btn1 = "5 ชั่วโมง";
                        Btn2 = "7 ชั่วโมง";
                        Btn3 = "10 ชั่วโมง";
                        Btn4 = "20 ชั่วโมง";
                ...
                case 4:
                    {
                        Head = "จุดแดงใหญ่ของดาวพฤหัสบดีปรากฏอยู่บริเวณใด";
                        Btn1 = "บริเวณซีกเหนือของดาวพฤหัสบดี";
                        Btn2 = "บริเวณซีกตะวันออกของดาวพฤหัสบดี";
                        Btn3 = "บริเวณซีกตะวันตกของดาวพฤหัสบดี";
                        Btn4 = "บริเวณซีกใต้ของดาวพฤหัสบดี";
                        break;
                    }
            }
        }
        if (planet == "Saturn")
        {
            ...
            switch (Count_Choice)
            {
                ...
                case 3:
                    {
                        Head = "วงแหวนของดาวเสาร์ประกอบด้วยอะไรเป็นไร";
                        Btn1 = "น้ำ";
                        Btn2 = "ดิน";
                        Btn3 = "ก้อนหินและน้ำแข็ง";
                        Btn4 = "โลหะแข็ง";
                        break;
                    }
                case 4:
        ...
        if (planet == "Uranus")
        {
            ...
            switch (Count_Choice)
            {
                case 1:
                    {
                        Head = "ดาวยูเรนัสโคจรรอบดวงอาทิตย์โดยหมุนรอบตัวเองในลักษณะใด";
                        Btn1 = "ลักษณะคว่ำ";
                        Btn2 = "ลักษณะหงาย";
                        Btn3 = "ลักษณะตะแคง";
                        Btn4 = "ลักษณะเอียงขวา";
        ...
        if (planet == "Neptune")
        {
            ...
            switch (Count_Choice)
            {
                case 1:
                    {
                        Head = "ดาวเนปจูนเป็นดาวเคราะห์สี";
                        Btn1 = "สีม่วง";
                        Btn2 = "สีฟ้าอ่อน";
                        Btn3 = "สีน้ำเงิน";
                        Btn4 = "สีเขียว";
